...
public class StreamingFormatTests
{
    ...
    [InlineData(StreamingFormat.WavPcm, "WAV PCM lossless")]
    [InlineData(StreamingFormat.L16Pcm, "WAV PCM lossless")]
    ...
    [InlineData(StreamingFormat.L16Pcm, "audio/wav")]
    ...
    [InlineData(StreamingFormat.L16Pcm, ".wav")]
